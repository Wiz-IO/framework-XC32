...
#define PLIB_PCACHE_ExistsWaitState PLIB_PCACHE_ExistsWaitState
static inline BOOL __attribute__((nomips16,nomicromips,always_inline)) 
...
static inline uint32_t __attribute__((nomips16,nomicromips,always_inline)) 
...
static inline PCACHE_PREFETCH_ENABLE __attribute__((nomips16,nomicromips,always_inline)) 
