...
// *****************************************************************************
/* Function:
    void SYSTEM_SetCacheCoherency(CACHE_COHERENCY cacheCoherency)
...
SYSTEM_SetCacheCoherency( CACHE_COHERENCY cacheCoherency )
{
    uint32_t cp0;
    cp0 = _mfc0(16, 0);
    cp0 &= ~0x07;
...
// *****************************************************************************
/* Function:
    CACHE_COHERENCY SYSTEM_GetCacheCoherency(void)
  ...
  Remarks:
    None.
*/
static inline CACHE_COHERENCY __attribute__((nomips16,nomicromips,always_inline)) 
SYSTEM_GetCacheCoherency( void )
{
 ...
 ********************************************************************/
static inline void __attribute__((nomips16,nomicromips,always_inline)) 
SYSTEM_CheKseg0CacheOff( void )
{
    SYSTEM_SetCacheCoherency( CACHE_DISABLE ); 
}
...
// *****************************************************************************
/* Function:
    void SYSTEM_PerformanceConfig( unsigned int sysclk, 
...
*/
static inline void __attribute__((nomips16,nomicromips,always_inline)) 
SYSTEM_PerformanceConfig( unsigned int sysclk, PCACHE_PREFETCH_ENABLE prefetch )
{
    unsigned int status;
    BOOL ecc;
...
// *****************************************************************************
/* Function:
    void SYSTEM_WaitStateConfig( unsigned int sysclk )
...
*/
static inline void __attribute__((nomips16,nomicromips,always_inline)) 
SYSTEM_WaitStateConfig( unsigned int sysclk )
{
    unsigned int status;
    BOOL ecc;
