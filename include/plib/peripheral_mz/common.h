...
static inline uintptr_t __attribute__ ( ( always_inline ) ) _PLIB_VirtToPhys_Default ( const void* p )
{
...
static inline void* __attribute__ ( ( always_inline ) ) _PLIB_PhysToVirtK0_Default ( uintptr_t a )
{
...
static inline void* __attribute__((always_inline)) _PLIB_PhysToVirtK1_Default( uintptr_t a )
{
