...
*/
static inline void __attribute__((nomips16,nomicromips,always_inline))  
INT_Enable(void)
{
...
/*******************************************************************************
  ...
  *****************************************************************************/
static inline unsigned int __attribute__((nomips16,nomicromips,always_inline)) __attribute__((optimize("-O0")))
...
/*******************************************************************************
  ...
  Remarks:
    This function cannot be compiled using the MIPS16 instruction set.
  *****************************************************************************/
static inline unsigned int __attribute__((nomips16,nomicromips,always_inline))  
...
/*******************************************************************************
  ...
  Remarks:
    This function cannot be compiled using the MIPS16 instruction set.
  *****************************************************************************/
static inline void __attribute__((nomips16,nomicromips,always_inline)) __attribute__((optimize("-O0"))) 
...
/*******************************************************************************
  Function:
    inline void __attribute__ ((always_inline)) INTSingleVectorRegisterSet(INT_SV_SS reg_set)
...
/*******************************************************************************
  Function:
    inline unsigned int __attribute__ ((always_inline)) INTGetInterruptVectorNumber(void)
...
/*******************************************************************************
  Function:
    inline INT_PRIORITY __attribute__ ((always_inline)) INTGetInterruptVectorPriority(void)
  ...
  Remarks:
    None.
  *****************************************************************************/
static inline INT_PRIORITY __attribute__ ((always_inline)) 
...
/*******************************************************************************
  Function:
    inline void __attribute__ ((always_inline)) INTGetInterruptVectorNumberAndPriority(unsigned int *number, INT_PRIORITY *priority)
...
/*******************************************************************************
  ...
  Remarks:
    None
  *****************************************************************************/
static inline INT_SUB_PRIORITY __attribute__ ((always_inline)) 
...
*/
static inline INT_SHADOW_REGISTER __attribute__ ((always_inline))
...
/*******************************************************************************
  Function:
    inline void __attribute__ ((always_inline)) INTSetIntProximityTimerReload(unsigned int time)
...
/*******************************************************************************
  Function:
    inline unsigned int __attribute__ ((always_inline)) INTGetIntProximityTimer(void)
...
/*******************************************************************************
  Function:
    inline void __attribute__ ((always_inline)) INTSetTemporalProximityControl(INT_TPC_GROUP level)
