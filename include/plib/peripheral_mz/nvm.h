...
*/
static inline void __attribute__((always_inline)) __attribute__((optimize("-O0"))) 
...
*/
static inline uint32_t __attribute__((always_inline)) __attribute__((optimize("-O0")))
...
*/
static inline BOOL __attribute__((always_inline)) __attribute__((optimize("-O0")))
...
*/
static inline void __attribute__((nomicromips, always_inline)) __attribute__((optimize("-O0")))
...
*/
static inline NVM_FLASH_SWAP_LOCK_TYPE __attribute__((always_inline)) __attribute__((optimize("-O0")))
...
/* Helper function */
static inline unsigned int __attribute__((nomicromips, always_inline)) __attribute__((optimize("-O0")))
...
static inline BOOL __attribute__((nomicromips, always_inline)) __attribute__((optimize("-O0")))
 ...
 ********************************************************************/
static inline unsigned int __attribute__((always_inline)) __attribute__((optimize("-O0"))) 
