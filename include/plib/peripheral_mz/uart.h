...
static inline INT_SOURCE __attribute__((always_inline)) 
...
*/
// UART Interrupt Channel.
static inline INT_VECTOR __attribute__((always_inline)) 
...
UARTSetDataRate ( UART_MODULE id, UINT sourceClock, UINT dataRate )
{
    ...
    if( (brgValueHigh > 0) && (brgValueHigh <= UINT16_MAX) ) //// [-Wtype-limits]
    {
    ...
    else if( (brgValueLow > 0) && (brgValueLow <= UINT16_MAX) ) //// [-Wtype-limits]
    {
        uart_mode++;                    //UxBRGCLR
        *uart_mode = _U1MODE_BRGH_MASK;        
...
/*******************************************************************************
  ...
  *****************************************************************************/
static inline UART_LINE_STATUS __attribute__((always_inline)) 
...
/*******************************************************************************
  ...
  *****************************************************************************/
static inline BYTE __attribute__((always_inline)) 
...
/*******************************************************************************
  ...
  Remarks:
    ...
    UARTSetLineControl).
  *****************************************************************************/
static inline UART_DATA __attribute__((always_inline)) 
